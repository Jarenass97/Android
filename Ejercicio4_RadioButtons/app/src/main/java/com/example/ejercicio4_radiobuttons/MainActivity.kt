...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var botonSumar: Button = findViewById(R.id.rbSuma)
        var botonRestar: Button = findViewById(R.id.rbResta)
        var botonMultiplicar: Button = findViewById(R.id.rbMultiplica)
        var botonDividir: Button = findViewById(R.id.rbDivide)
